...
export default function Sidenav() {
  ...
  return (
    ...
    md:items-center sm:items-center lg:p-8 md:p-8 sm:p-4 xl:p-8 xl:pt-16 lg:pt-16 md:pt-8 sm:pt-8
     xl:gap-y-8 lg:gap-y-8 md:gap-y-0 sm:gap-y-0 xl:justify-start
