...
export default function Imgsec() {
  return (
    <div className="col-span-1 flex xl:justify-end xl:items-start sm:mt-16 md:mt-8
    xl:mt-0 lg:mt-0  lg:justify-end lg:items-start md:justify-center md:items-start sm:justify-center sm:items-start">
      <img
        style={{ rotate: "0deg" }}
